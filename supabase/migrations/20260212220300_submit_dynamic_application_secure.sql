-- ==============================================
-- ADU-07: Secure Dynamic Application Submission
-- Replaces insecure direct INSERT from anon client
-- ==============================================
...
GRANT EXECUTE ON FUNCTION public.submit_dynamic_application_secure(UUID, TEXT, JSONB, TEXT) TO anon;
GRANT EXECUTE ON FUNCTION public.submit_dynamic_application_secure(UUID, TEXT, JSONB, TEXT) TO authenticated;
