-- Drop the unused and broken function
DROP FUNCTION IF EXISTS public.submit_application_secure(uuid, text, jsonb, text);

-- Fix the enum comparison in submit_dynamic_application_secure
